...
export const CreateTodoForm = React.memo(() => {
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="rounded-full bg-[var(--primary-background)] p-[8px_20px] text-center text-sm font-bold text-[var(--primary-foreground)]"
      >
        Add
      </button>
    </form>
